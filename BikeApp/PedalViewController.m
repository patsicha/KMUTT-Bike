...
#import "PedalViewController.h"

@interface PedalViewController ()
{
...
@implementation PedalViewController
...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"paddle" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"Magnet_Pedal"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 150, 150) interpolationQuality:kCGInterpolationHigh]];
    ...
    if([[Durability objectForKey:@"padel"] isEqualToString:@"br"])
    {
...
- (void)aMethod:(UIButton*)button
{
    ...
    NSMutableDictionary *Durability = [[NSMutableDictionary alloc] initWithDictionary:[prefs objectForKey:@"Durability"]];
    if([[Durability objectForKey:@"pedal"] isEqualToString:@"br"]) [Durability setValue:@"ni" forKey:@"pedal"];

...
#import "SaddleViewController.h"

@interface SaddleViewController ()
{
...
@implementation SaddleViewController
...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"saddle" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"saddle"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 150, 150) interpolationQuality:kCGInterpolationHigh]];
    ...
    if([[Durability objectForKey:@"saddle"] isEqualToString:@"B"])
    {
...
- (void)aMethod:(UIButton*)button
{
    ...
    NSMutableDictionary *Durability = [[NSMutableDictionary alloc] initWithDictionary:[prefs objectForKey:@"Durability"]];
    if([[Durability objectForKey:@"saddle"] isEqualToString:@"B"]) [Durability setValue:@"G" forKey:@"saddle"];

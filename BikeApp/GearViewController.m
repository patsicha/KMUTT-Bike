...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"crank" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"crank"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 150, 150) interpolationQuality:kCGInterpolationHigh]];

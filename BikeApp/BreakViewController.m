...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"break" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"brake"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 150, 150) interpolationQuality:kCGInterpolationHigh]];
...
- (void)aMethod:(UIButton*)button
{
    ...
    NSMutableDictionary *Durability = [[NSMutableDictionary alloc] initWithDictionary:[prefs objectForKey:@"Durability"]];
    if([[Durability objectForKey:@"break"] isEqualToString:@"br"]) [Durability setValue:@"ni" forKey:@"break"];

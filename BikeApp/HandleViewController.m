...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"handle" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"HandleBars"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 150, 150) interpolationQuality:kCGInterpolationHigh]];
    ...
    if([[Durability objectForKey:@"handle"] isEqualToString:@"B"])
    {
...
- (void)aMethod:(UIButton*)button
{
    ...
    NSMutableDictionary *Durability = [[NSMutableDictionary alloc] initWithDictionary:[prefs objectForKey:@"Durability"]];
    if([[Durability objectForKey:@"handle"] isEqualToString:@"B"]) [Durability setValue:@"G" forKey:@"handle"];

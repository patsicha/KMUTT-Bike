...
- (void)viewDidLoad
{
    ...
    NSString *txtFilePath = [[NSBundle mainBundle] pathForResource: @"tire" ofType: @"txt"];
    ...
    img0 = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"tire_pic01"] resizedImageWithContentMode:UIViewContentModeScaleAspectFill bounds:CGSizeMake( 100, 100) interpolationQuality:kCGInterpolationHigh]];
...
- (void)aMethod:(UIButton*)button
{
    ...
    NSMutableDictionary *Durability = [[NSMutableDictionary alloc] initWithDictionary:[prefs objectForKey:@"Durability"]];
    if([[Durability objectForKey:@"wheel"] isEqualToString:@"B"]) [Durability setValue:@"G" forKey:@"wheel"];
